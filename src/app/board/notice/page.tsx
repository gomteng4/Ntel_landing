        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">중요한 공지사항을 확인해주세요.</p>
            </div>
            <Link 
              href="/"
              className="text-blue-600 hover:text-blue-800 font-medium"
          ...
          <div className="divide-y divide-gray-200">
            {posts.length === 0 ? (
              ...
              posts.map((post, index) => (
                <div key={post.id} className={`p-6 hover:bg-gray-50 transition-colors ${post.is_pinned ? 'bg-blue-50' : ''}`}>
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center space-x-2 mb-2">
                        {post.is_pinned && (
                          <span className="bg-red-500 text-white px-2 py-1 text-xs font-medium rounded">📌 공지</span>
                        )}
